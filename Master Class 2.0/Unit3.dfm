object Form3: TForm3
  ...
  object ProdutoTable: TFDQuery
    ...
    Left = 116
    Top = 255
    object ProdutoTableGUUID: TStringField
      FieldName = 'GUUID'
      Origin = 'GUUID'
    ...
    object ProdutoTablePRECO: TBCDField
      FieldName = 'PRECO'
      Origin = 'PRECO'
      Precision = 18
    end
    ...
    object ProdutoTableALIQUOTA: TBCDField
      FieldName = 'ALIQUOTA'
      Origin = 'ALIQUOTA'
      Precision = 18
    end
    ...
    object ProdutoTableDATAALTERACAO: TSQLTimeStampField
